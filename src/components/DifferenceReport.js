    ...
    <div className="mb-4">
      ...
      <div className="mb-4 px-4">
        ...
        <input
          ...
          className="w-1/2" // Adjusted width for the slider
        />
      ...
      <div className={`bg-gray-100 p-4 rounded shadow-md mb-4 text-center transition-all duration-300 ${showLogic ? 'h-auto' : 'h-0 overflow-hidden'}`}>
